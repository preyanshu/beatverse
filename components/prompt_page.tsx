  ...
  const handleUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    audio.onloadedmetadata = () => {
      if (audio.duration > 30) {
        toast.error('Audio file must be less than 30 seconds.');
      } else {
        setTracks((prevTracks) => [
          ...prevTracks,
          { prompt: 'Uploaded audio', blob: file },
        ]);
    ...
    <div className="w-[100vw] max-w-[24rem]  min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-black via-gray-900 to-purple-950 text-gray-200">
      <div className="bg-gray-800 text-gray-300 shadow-xl rounded-xl p-8 max-w-xl w-full">
        ...
        <p className="text-lg mb-6 text-center">
          Create/Select your musical piece based on today's theme. Use your imagination to craft a prompt and let the AI generate something extraordinary or just load your audio file
        </p>
...
<div className="flex justify-center space-x-4 w-full  items-center flex-col">
...
<input
          ...
          className="block mb-6 w-[100%] p-4 border border-purple-400 rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-400"
